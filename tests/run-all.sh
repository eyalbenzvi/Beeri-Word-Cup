...
run_test "1. Scoring Logic" "scoring/test-scoring.mjs" "no"
...
run_test "16. Phone Auth & OTP Security" "auth/test-phone-auth.mjs" "no"
...
run_test "25. Sentry Wrapper" "store/test-sentry-wrapper.mjs" "no"
...
run_test "41. Focus Trap Hook" "ui/test-focus-trap.mjs" "no"
