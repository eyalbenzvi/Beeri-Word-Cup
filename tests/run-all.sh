...
run_test "3b. Third Place Early Certainty" "bracket/test-thirdplace-certainty.mjs" "yes"
run_test "3c. Group Winner Early Certainty" "bracket/test-group-winner-certainty.mjs" "yes"
...
run_test "21b. Rank History Perf (derived-trend build budget + cache)" "perf/test-rank-history-perf.mjs" "yes"
...
run_test "28b. User Time (localized display, viewer timezone)" "data/test-user-time.mjs" "yes"
...
run_test "39b. Scenario Infographic (likely finals + favorite form + svg export)" "bracket/test-scenario-infographic.mjs" "yes"
...
run_test "102. Rank Trend (derived chronological history + ranking + cache + wiring)" "ui/test-rank-trend.mjs" "yes"
